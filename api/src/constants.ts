...
export const JWT_SECRET = process.env.JWT_SECRET || '1fef2b04-ce17-4365-bfa4-0394c7441dfd'
...
export const APP_SECRET = process.env.APP_SECRET || 'e2b56457-9301-4724-aeb5-72fd8b3b315a'
